...
### 5. AI Game Intelligence Pipeline

An AI-powered automation workflow that analyzes mobile game concepts, in-game economies, and monetization fairness. The workflow uses LLM-based reasoning to evaluate inputs, performs structured validation, and generates automated HTML reports delivered via email.
Focus: AI reasoning pipelines, evaluation automation, structured output generation.

## Technologies Used

* n8n
* OpenAI / OpenRouter / Google Gemini LLMs
...
4. Add your API credentials (OpenAI / Gemini, Google, Pinecone, etc.).
5. Activate the workflow.

## Project Purpose

This repository showcases automation capabilities across multiple domains, demonstrating skills in workflow design, API orchestration, LLM integration, RAG architecture, and AI-driven evaluation systems. Suitable for employers evaluating AI automation, workflow engineering, or data engineering proficiency.
